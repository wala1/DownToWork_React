			...
			<div className="body_wrap">
				<div className="page_wrap">
					...
					<div class="page_content_wrap">
						<div class="content_wrap" style={{ marginTop: "200px", marginBottom: "70px" }}>
							<div class="content">
												...
												<div class="cart_totals ">
													...
													<table>
														<tr class="cart-subtotal">
															<th>Subtotal</th>
															<td><span class="amount">&pound;{cart.total}</span></td>
														</tr>
														<tr class="order-total">
															<th>Total</th>
															<td>
																<strong><span class="amount">&pound;{cart.total}</span></strong>
															</td>
														</tr>
													</table>
