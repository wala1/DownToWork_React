...
//     try {
//       const response = await axios.get(`http://localhost:3001/product/getById/${id}`);
                    ...
                    <div class="content">
                        <article class="post_item post_item_single post_item_product">
                            <div class="product has-post-thumbnail">
                                ...
                                <img src={`http://localhost:3001/${selectedProduct.prodImg.imgUrl}`} alt="" style={{ minHeight: "150px", maxHeight: "150px" }} />
                                ...
                                <div class="summary entry-summary">
                                    <h1 class="product_title entry-title">{selectedProduct.prodDesc}</h1>
                                    ...
                                    <div>
                                        <p class="price"><span class="amount">&pound;{selectedProduct.prodPrice}</span></p>
                                    </div>
                                    <div>
