...
function ProductPage(props) {
  ...
  console.log(id);
  // const products = [
  //   { id: 1, name: 'Product 1', description: 'Description 1',img:"uploads/1683479688488-Vincent Van Gogh.jpg" },
  ...
  return (<body className="archive body_style_wide body_filled article_style_boxed layout_single-standard top_panel_style_dark top_panel_opacity_transparent  top_panel_above menu_right sidebar_show sidebar_right woocommerce woocommerce-page">
    {/* archive body_style_wide body_filled article_style_boxed top_panel_style_light top_panel_opacity_solid top_panel_above menu_right sidebar_show sidebar_right woocommerce woocommerce-page */}
      ...
      {/* <!-- Content -->					 */}
                ...
                {/* <img src={`http://localhost:3001/${product.prodImg.imgUrl}`} alt=""  /> */}
                  ...
                  <img src="http://placehold.it/50x50" alt="" title="" /></a>
                            ...
                            <div class="summary entry-summary">
                                <h1 class="product_title entry-title">{product.prodDesc}</h1>
